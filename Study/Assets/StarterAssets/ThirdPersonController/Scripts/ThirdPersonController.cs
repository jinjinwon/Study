...
{
    // RequireComponent : 요구되는 컴포넌트를 종속성으로 자동으로 추가해줍니다.
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private int _animIDAttackRandom;
        ...
        private void Start()
        {
            ...
            // 애니메이션 상태 ID를 설정하고, 점프/낙하 타임아웃 값을 초기화
            AssignAnimationIDs();
        ...
        private void AssignAnimationIDs()
        {
            ...
            _animIDAttackRandom = Animator.StringToHash("AttackRandom");
        }
        ...
        private void OnAttack()
        {
            if (_hasAnimator)
            {
                ...
                _animator.SetFloat(_animIDAttackRandom, Random.Range(0,7));
            }
        }
